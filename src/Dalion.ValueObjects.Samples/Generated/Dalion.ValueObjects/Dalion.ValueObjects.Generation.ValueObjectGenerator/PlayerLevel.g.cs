...
#pragma warning restore CS0414
        ...
        private class PlayerLevelTypeConverter : System.ComponentModel.TypeConverter
        {
            ...
            {
                return sourceType is not null && (sourceType.IsAssignableFrom(typeof(PlayerLevel)) || sourceType.IsAssignableFrom(UnderlyingType) || sourceType == typeof(string));
            }
            ...
            {
                return destinationType is not null && (destinationType.IsAssignableFrom(typeof(PlayerLevel)) || destinationType.IsAssignableFrom(UnderlyingType) || destinationType == typeof(string));
            }
