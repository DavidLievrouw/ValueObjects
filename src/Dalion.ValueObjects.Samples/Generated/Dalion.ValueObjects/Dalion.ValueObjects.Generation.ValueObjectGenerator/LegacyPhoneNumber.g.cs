...
#pragma warning restore CS0414
        ...
        public static LegacyPhoneNumber From(System.String? value) {
            ...
            if (!vo.IsValid() && vo.Value is not null && !LegacyPhoneNumberPreSetValueCache.LegacyPhoneNumberPreSetValues.TryGetValue(vo.Value, out _)) {
        ...
        private class LegacyPhoneNumberTypeConverter : System.ComponentModel.TypeConverter
        {
            ...
            {
                return sourceType is not null && (sourceType.IsAssignableFrom(typeof(LegacyPhoneNumber)) || sourceType.IsAssignableFrom(UnderlyingType) || sourceType == typeof(string));
            }
            ...
            {
                return destinationType is not null && (destinationType.IsAssignableFrom(typeof(LegacyPhoneNumber)) || destinationType.IsAssignableFrom(UnderlyingType) || destinationType == typeof(string));
            }
            
            public override object? ConvertTo(System.ComponentModel.ITypeDescriptorContext? context, System.Globalization.CultureInfo? culture, object? value, Type destinationType)
            {
                if (destinationType.IsAssignableFrom(typeof(LegacyPhoneNumber)))
                {
                    if (value is LegacyPhoneNumber vo)
                    {
                        return vo;
