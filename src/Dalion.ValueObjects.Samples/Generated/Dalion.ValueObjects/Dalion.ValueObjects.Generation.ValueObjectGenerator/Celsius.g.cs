...
#pragma warning restore CS0414
        ...
        private class CelsiusTypeConverter : System.ComponentModel.TypeConverter
        {
            ...
            {
                return sourceType is not null && (sourceType.IsAssignableFrom(typeof(Celsius)) || sourceType.IsAssignableFrom(UnderlyingType) || sourceType == typeof(string));
            }
            ...
            public override object? ConvertFrom(System.ComponentModel.ITypeDescriptorContext? context, System.Globalization.CultureInfo? culture, object value)
            {
                ...
                if (value is System.Decimal correctlyTypedValue)
                {
                ...
                if (value is string s)
                {
                    ...
                    return underlyingValue == default 
                        ? Zero 
                        : From((System.Decimal)underlyingValue);
                }
            ...
            {
                return destinationType is not null && (destinationType.IsAssignableFrom(typeof(Celsius)) || destinationType.IsAssignableFrom(UnderlyingType) || destinationType == typeof(string));
            }
            
            public override object? ConvertTo(System.ComponentModel.ITypeDescriptorContext? context, System.Globalization.CultureInfo? culture, object? value, Type destinationType)
            {
                if (destinationType.IsAssignableFrom(typeof(Celsius)))
                {
                    if (value is Celsius vo)
                    {
                        return vo;
